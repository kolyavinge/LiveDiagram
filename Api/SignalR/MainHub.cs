...
namespace LiveDiagram.Api.SignalR
{
    public class MainHub : Hub
    {
        ...
        public async Task DiagramItemEditResponse(object responseContainerJson)
        {
            await SendAsync("DiagramItemEditResponse", responseContainerJson);
        }
        ...
        public async Task ActionSetActiveResponse(object responseContainerJson)
        {
            await SendAsync("ActionSetActiveResponse", responseContainerJson);
        }
